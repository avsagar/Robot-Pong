  ...
  while not rospy.is_shutdown():
    ...
    if trans_array[1] < 0.1651: #over front line
      ...
      if cross >= c and not rot:
        ...
        print("Spin concluded, going straight")
        if todo == 1:
          todo = 2
          changed = True
        elif todo == 2:
...
if __name__ == '__main__':
  ...
  target_address1 = "00:14:03:06:2D:E1"
  target_address2 = "98:D3:71:FD:51:47"
  port1 = 1
